...
import {NotFoundProductDetailsQuery} from '../graphql/generated';
/**
 *
...
export default function NotFound({
  ...
  const {data} = useShopQuery<NotFoundProductDetailsQuery>({
    query: QUERY,
    variables: {
  ...
  const products = data ? (flattenConnection(data.products) as Product[]) : [];
